...
<div style="text-align: center; margin: 2rem 0;">
  <img src="/assets/images/projects/etko/pipeline-flow.png" alt="Pipeline Flow Architecture" style="max-width: 280px; height: auto; border: 1px solid var(--border-color); border-radius: 8px; padding: 1.5rem; background: white;">
</div>
